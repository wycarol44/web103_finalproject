...
- [ ] Frontend: Build achievements display
- [ ] Frontend: Add edit functionality to Dashboard
...
- [ ] Frontend: Build case submission form component with character counters
...
- [ ] Database: Design votes table (case_id, user_id, target_type, target_id, vote_type, created_at). Add constraint to prevent duplicate votes per user per item
...
- [ ] Frontend: Build evidence submission form component with character counter and image upload field
...
- [ ] Database: Add assigned_judge_id and judge_ruling to cases table
- [ ] Backend: Create logic to assign judge for each case
- [ ] Backend: Create GET /cases/:id/jury-verdict endpoint (if phase is in progress, only return total vote count. if phase is over, ALSO return jury results)
...
### 12. Contribution History (Visible on Dashboard and Profile)
- [ ] Backend: Create GET /users/:id/activity endpoint (ALL contributions: likes, submissions, evidence, arguments, jury duty). ensure user auth
- [ ] Backend: Create GET /users/:id/contributions endpoint (PUBLIC contributions: evidence, arguments, submissions)
- [ ] Backend: Allow querying with pagination or by case
- [ ] Backend: Return evidence, arguments, jury votes, submissions
- [ ] Frontend: Build Dashboard page component: Provisional
- [ ] Frontend: Build Dashboard page component: Evidence
- [ ] Frontend: Build Dashboard page component: Arguments
- [ ] Frontend: Build Dashboard page component: Jury Duty
- [ ] Frontend: Build Profile page component: Contributions (evidence, arguments, submissions)
- [ ] Frontend: Show contribution type (submission, evidence, argument)
...
- [ ] Frontend: Display earned and in progress achievements on profile
